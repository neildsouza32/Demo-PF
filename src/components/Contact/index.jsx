        ...
        <div className="contact_group">
          <div className="contact_options">
            <article className="contact_option">
              ...
              <h3>Email</h3>
              <h5>neiladsouza32@gmail.com</h5>
              <a href="mailto:neiladsouza32@gmail.com" target='_blank' className='btn'>Send a Message</a>
            </article>
            <article className="contact_option">
            ...
            <article className="contact_option">
              ...
              <h3>Whatsapp</h3>
              <h5>+91 9356062895</h5>
              <a href="https://api.whatsapp.com/send?phone=9356062895" target='_blank' className='btn'>Send a Message</a>
            </article>
          </div>
          <form>
